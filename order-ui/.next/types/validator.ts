...
// Validate ../../app/api/internal/token/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/internal/token">> = Specific
  const handler = {} as typeof import("../../app/api/internal/token/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
